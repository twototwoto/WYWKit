#
#  Be sure to run `pod spec lint WYWKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "twototwoto"
  # spec.authors            = { "twototwoto" => "2637405168@qq.com" }
  # spec.social_media_url   = "https://twitter.com/twototwoto"
